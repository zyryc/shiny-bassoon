    ...
    <div class="content">
      ...
      <div>
        ...
        Hello,
          <br>
          <br>
		  Your password reset request has been received, please click on the link below to reset it
        </p>
        <button type="button"><a href="<?php echo base_url('basic/reset_password/'). $forgotten_password_code; ?>">Click here to reset password</a></button>
        <p>
        Kind regards <br>
		Good job. <br>
		Ticket For You <br>
